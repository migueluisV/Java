...
Similar al método 2 para lectura de archivos, la clase \textbf{FileWriter} recibe la ruta de un archivo para trabajar con él, y la clase \textbf{PrintWriter} se encarga de escribir en el objeto \textit{FileWriter}, estas clases deben ser importadas:\begin{center}\textit{import java.io.FileWriter;\\import java.io.PrintWriter;}\end{center}
